                        ...
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select name="category_id" class="form-control select2"
                                    ...
                                    <option value="{{ $row->id }}"
                                        @php if ($row->id == $product->category_id ) { echo 'selected'; } @endphp>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select name="subcategory_id" class="form-control select2"
                                    ...
                                    <option value="{{ $row->id }}"
                                        @php if ($row->id == $product->subcategory_id ) { echo 'selected'; } @endphp>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select name="brand_id" class="form-control select2" data-placeholder="Choose Brand">
                                    ...
                                    @foreach ($brand as $row)
                                    <option value="{{ $row->id }}"
                                        @php if ($row->id == $product->brand_id ) { echo 'selected'; } @endphp>
