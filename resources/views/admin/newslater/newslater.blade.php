        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content tx-size-sm" style="min-width: 350px;">
                <div class="modal-header pd-x-20">
                    <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Newslater Email Add</h6>
                ...
                <form action="{{ route('store.coupon') }}" method="post">
                    ...
                    <div class="modal-body pd-20">
                        <div class="form-group">
                            <label for="text1">Newslater Email</label>
                            <input type="email" class="form-control" id="text1" name="coupon"
