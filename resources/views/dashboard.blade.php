            ...
            <ul class="header_menu">
                ...
                <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                    <div class="user_item dropdown-menu dropdown-menu-right">
                        <div class="admin">
                            <a href="#" class="user_link"><img src="{{ asset('panel/assets/images/admin.jpg') }}"
                                    alt=""></a>
                        </div>
                        <ul>

                            <li><a href="{{ route('profile.edit') }}"><span><i class="fas fa-user"></i></span> User
                                    Profile</a></li>
                            <li>
                ...
                <section class="table_area">
                    <div class="panel">
                        <div class="panel_header">
                            <div class="panel_title"><span>FooTable with row toggler, sorting, filter and
                                    pagination</span></div>
                        </div>
